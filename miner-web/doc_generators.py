...
GENERATORS: List[Dict[str, Any]] = [
    ...
    {
        "id": "decentralization-skeptic-rebuttal",
        "title": "Decentralization Skeptic Rebuttal",
        "category": "white-paper",
        "description": "Blunt rebuttal to lazy “not decentralized” takes — with runnable verification tests.",
        "runtime": "node",
        "script": f"{DOCS_ROOT}/generate-decentralization-skeptic-rebuttal.js",
        "cwd": DOCS_ROOT,
        "output_path": f"{DOCS_ROOT}/Bloodstone-Decentralization-Skeptic-Rebuttal.docx",
        "downloads_name": "Bloodstone-Decentralization-Skeptic-Rebuttal.docx",
        "mesh_key": "downloads/Bloodstone-Decentralization-Skeptic-Rebuttal.docx",
        "mesh_display_name": "Bloodstone Decentralization Skeptic Rebuttal",
        "version": "1.0",
    },
    {
