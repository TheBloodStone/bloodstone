    ...
    return [
        ...
        },
        {
            ...
            "detail": (
                ...
                f"{ai.AI_ROUTING_FORMAT} on-device AI routing + multi-tenant compute/bandwidth/storage quota"
            ),
...
def status_payload() -> Dict[str, Any]:
    ...
    return {
        ...
        "roadmap": "Wave A–Q ✓ · Wave R: storage tenant + AI DTN route export + coordinator inference ✓",
        "layers": layer_status(),
        "mesh_v2": {
